...
class BlogPostModel extends Model
{
    ...
    protected $fillable = array('id', 'name','slug','status','page_title','meta_keywords','meta_description','posted_by','posted_date','image','short_description','description','views_count','category_id','tags_ids','meta_other');
    ...
    public static function getCatPostUrl($post_slug)
     ...
     public static function getmonthsofyear($year){
        ...
        $years = BlogPostModel::selectRaw("MONTH(posted_date) as month")->distinct()->orderBy('month','ASC')->get();
        return $years;
    }
