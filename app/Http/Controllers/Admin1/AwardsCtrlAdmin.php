...
public function roleChecking() {
  ...
  $this->roleChecking(); 
    ...
    if(isset($_GET['delete'])){
        $delete_status = AwardsModel::find($_GET['delete'])->delete();
 ...
 $data_rows=AwardsModel::orderBy('sorting', 'desc');
   ...
   if($_POST['submit_type']=='3' && $id!=''){
    ...
    $this->validate($request,$array_validate);  
        ...
        $new_file_name=$filename_remove[0];       
            ...
            $destinationPath = public_path('/media/images/awards/image_path');
            $image_path->move($destinationPath, $image_name);
           $_POST['image_path']='media/images/awards/image_path/'.$image_name;
        } else {
