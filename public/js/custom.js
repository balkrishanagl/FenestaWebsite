...
//       $(window).scrollTop() > $('.fe-galray-box').height() || 
//       $(window).scrollTop() > notFound){
...
//  ############# 20 Aug- 2021 Ipad js showing slider #############

  // $('.science-work-list-ipad').addClass('owl-carousel');
  //   $('.science-work-list-ipad').owlCarousel({
  //     items: 3,
  //     margin:10,
  //     loop: true,
  //     autoplay:false,
  ...
  //   }).on('changed.owl.carousel',function(event){   
  //     console.log(event.item.index)   
  //     var imageName = $('.science-work-list-ipad .owl-item').eq( event.item.index).find('.item').data('image');
  //     $('.middle .center-image img').attr('src',imageName);
  //   });
  // }
  ...
  $(document).on('click', '.upvc-windows .load-more', function () {
//  		var handleSize = 32;
      
    var handleSize = $('.upvc-windows').find('.handle-list .item').length;
    ...
    if(handleShow === handleSize){
      $(this).closest('.upvc-windows').find('.load-btn .load-more').hide();
      $(this).fadeOut();
      $(this).closest('.upvc-windows').find('.load-btn .load-less').show(); 
    }
  ...
  $(document).on('click', '.upvc-windows .load-less', function () {
      if($(window).width() <= 767){
          handleShow = (handleShow-15 < 15) ? 15 : handleShow-15;  

      }else{
        handleShow = (handleShow-15 < 15) ? 15 : handleShow-15;
      }        
       $(this).closest('.upvc-windows').find('.handle-list .item').not(':lt('+handleShow+')').slideUp();
         if(handleShow <= 15 || handleShow <= 15){
          $(this).closest('.upvc-windows').find('.load-btn .load-less').hide();
           $(this).fadeOut();
            $(this).closest('.upvc-windows').find('.load-btn .load-more').show(); 
         }
  });
...
// 20 aug 2021
  ...
  if($(window).width() > 767){
    $('.science-work-list .item').mouseover(function(){
  ...
  $(document).on('click', '.inner-top-nav-content .load-more', function () {
    ...
    if(handleShow === handleSize){
      $(this).closest('.inner-top-nav-content').find('.load-btn .load-more').hide();
      $(this).fadeOut();
      $(this).closest('.inner-top-nav-content').find('.load-btn .load-less').show(); 
    }
  ...
  $(document).on('click', '.inner-top-nav-content .load-less', function () {
      if($(window).width() <= 767){
          handleShow = (handleShow-15 < 15) ? 15 : handleShow-15;  
       ...
       $(this).closest('.inner-top-nav-content').find('.handle-list .item').not(':lt('+handleShow+')').slideUp();
         if(handleShow <= 15 || handleShow <= 15){
          $(this).closest('.inner-top-nav-content').find('.load-btn .load-less').hide();
           $(this).fadeOut();
            $(this).closest('.inner-top-nav-content').find('.load-btn .load-more').show(); 
         }
  });
 ...
 // });
  ...
  $(document).on('click', '.retail .load-more', function () {
      ...
      if(retailShow == retailSize){
        $(this).closest('.inner-div').find('.load-btn .load-more').hide();
        $(this).fadeOut();
        $(this).closest('.inner-div').find('.load-btn .load-less').show();
      }

      faqDist = $('.faq-sec').offset().top - faqDistTop ;
  });
  $(document).on('click', '.retail .load-less', function () {
      
     retailShow = (retailShow-3 < 3) ? 3 : retailShow-3;      
     $(this).closest('.inner-div').find('.customer-rev-list .item').not(':lt('+retailShow+')').slideUp();
//      alert(awardShow);
     if(retailShow <= 3){
      $(this).closest('.inner-div').find('.load-btn .load-less').hide(); 
       $(this).fadeOut();
        $(this).closest('.inner-div').find('.load-btn .load-more').show(); 
     }
 });
  ...
  $(document).on('click', '.testimonial .load-less', function () {
      
     testimonialShow = (testimonialShow-3 < 3) ? 3 : testimonialShow-3;      
     $(this).closest('.inner-div').find('.customer-rev-list .item').not(':lt('+testimonialShow+')').slideUp();
//      alert(awardShow);
     if(testimonialShow <= 3){
      $(this).closest('.inner-div').find('.load-btn .load-less').hide(); 
       $(this).fadeOut();
        $(this).closest('.inner-div').find('.load-btn .load-more').show(); 
     }
  ...
  $(document).on('click', '.project .load-less', function () {
      
     projectShow = (projectShow-3 < 3) ? 3 : projectShow-3;      
     $(this).closest('.inner-div').find('.customer-rev-list .item').not(':lt('+projectShow+')').slideUp();
//      alert(awardShow);
     if(projectShow <= 3){
      $(this).closest('.inner-div').find('.load-btn .load-less').hide(); 
       $(this).fadeOut();
  ...
  $(document).on('click', '.award-accreditation-tab .load-more', function () { 
      ...
      if(awardShow == awardSize){
        $(this).closest('.award-accreditation-tab-box').find('.load-btn .load-more').hide(); 
        $(this).fadeOut();
         $(this).closest('.award-accreditation-tab-box').find('.load-btn .load-less').show(); 
      }
  });
 $(document).on('click', '.award-accreditation-tab .load-less', function () {
      
     awardShow = (awardShow-8 < 8) ? 8 : awardShow-8;      
     $(this).closest('.award-accreditation-tab-box').find('.award-accreditation-list .item').not(':lt('+awardShow+')').slideUp();
//      alert(awardShow);
     if(awardShow <= 8){
      $(this).closest('.award-accreditation-tab-box').find('.load-btn .load-less').hide();
       $(this).fadeOut();

        $(this).closest('.award-accreditation-tab-box').find('.load-btn .load-more').show(); 
     }
 });
  ...
  $('.color-list .item').click(function(){
    ...
    $(this).closest('.color-finish-box').find('.right .slider-box').hide();
    $(this).closest('.color-finish-box').find('.right .slider-box').eq(colorIndex).fadeIn();
  ...
  $(window).scroll(function(){                                                                                                            
    console.log($(window).scrollTop())       
     if(
      ...
      //$(window).scrollTop() > $('.inner-page').height() || 
      $(window).scrollTop() > $('.style-benefit-sec').height() || 
      $(window).scrollTop() > $('.thanku_wrapper').height() || 
      $(window).scrollTop() > $('.our-office-sec').height() || 
      $(window).scrollTop() > $('.blog-sec').height()  || 
      $(window).scrollTop() > $('.blog-info-sec').height() || 
//      $(window).scrollTop() > $('.galley-box').height() || 
      $(window).scrollTop() > $('.accreditation-sec').height() || 
      $(window).scrollTop() > $('.brochure_wrap').height() || 
      $(window).scrollTop() > $('.latest-event-sec ').height() || 
      $(window).scrollTop() > $('.inner-banner').height() ||
      $(window).scrollTop() > $('.scroll-gallery').height() || 
      $(window).scrollTop() > notFound){
        $('.mobile-footer').addClass('active');
        clearInterval(clearInterval);
     }else{
...
$(window).on('load', function(){
  ...
  $('.right-slider').css({'height':$('.right-slider').height(),'overflow':'hidden'});
...
$("header .menu-list li.drop-down > span").click(function(){
    if($(this).next(".submenu").is(":visible")){
        $(this).next(".submenu").slideUp();  
    }
    else{
        $("header .menu-list li.drop-down > .submenu").slideUp();
        $(this).next(".submenu").slideDown();
    }
});

$(".submenu > ul > li > span.fa").click(function(){
    if($(this).next(".sub_dropdown_menu").is(":visible")){
        $(this).next(".sub_dropdown_menu").slideUp(); 
    
    
    }
    else{
        $(".submenu > ul > li > .sub_dropdown_menu").slideUp();
        $(this).next(".sub_dropdown_menu").slideDown();
