...
<th><input type="checkbox" id="select_all" /></th>
        ...
        <tbody>
              <?php $er=1;
            ?>
                <?php $__currentLoopData = $data_rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=> $data_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($i<41 || $i>43){
 ...
 <td><input type="checkbox" class="checkbox" data-emp-id="<?php echo e($data_row->id); ?>" value="<?php echo e($data_row->id); ?>"/></td>
                  ...
                  <td> <?php echo e($er++); ?></td>
                 <td> <?php if(isset($p_title)): ?> <?php echo e($p_title); ?> <?php else: ?> Default <?php endif; ?></td> 
            ...
            <td><span class="label label-<?php echo ($data_row->status=='1')?'success':'danger';?>">
                  ...
                  <a href="<?php echo Request::url();?>?delete=<?php echo $data_row->id;?>" title="Delete " class="delete" onclick="return confirm('Are you sure you want to delete <?php echo e($data_row->name); ?>?');"><i class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
           <?php } ?>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/blog-page/index.blade.php ENDPATH**/ ?>