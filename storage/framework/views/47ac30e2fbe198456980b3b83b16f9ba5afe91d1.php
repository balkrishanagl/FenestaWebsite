...
<div class="col-md-8 text-left">
    <h1 class="m-0 text-dark"> Series List</h1></div>
<div class="col-md-4 text-right">
              <a class="btn btn-primary"  title="Add New" href="<?php echo e(URL::to('/')); ?>/admin/Series"><i class="fa fa-plus"></i> Add New</a>
...
<?php endif; ?>
<div class="card-body table-responsive p-0">  <input type="hidden" class="tb" value="series">
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		...
		<tbody>
			...
			<tr><td><input type="checkbox" class="checkbox" data-emp-id="<?php echo e($newz->id); ?>" value="<?php echo e($newz->id); ?>"/></td>
				...
				<td>
                    <img height="50px" width="50px" src="<?php echo e(asset("images/series/$newz->image")); ?>" >
                   
                </td><td><?php echo e($newz->status); ?> </td>
				<td><a  title="Edit" href="<?php echo e(URL('admin/editSeries',['id' => $newz->id])); ?>"><i class="fas fa-edit"></i></a> <a href="#" data-id = "<?php echo e($newz->id); ?>" title="Delete" class="delete"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
			<?php $i++; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		</tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/Series/listSeries.blade.php ENDPATH**/ ?>