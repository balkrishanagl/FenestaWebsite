...
<?php $__env->startSection('title', 'Windows Product List'); ?>

<?php $__env->startSection('content_header'); ?>
<div class="row">
<div class="col-md-8 text-left">
    <h1 class="m-0 text-dark"> Windows Product List</h1></div>
<div class="col-md-4 text-right">
              <a class="btn btn-primary" title="Add New" href="<?php echo e(URL::to('/')); ?>/admin/Window/typeadd"><i class="fa fa-plus"></i> Add New</a>
...
<div class="card-body table-responsive p-0">
       ...
       <input type="hidden" class="tb" value="windowdoor_types">
...
<!--				<th>Type</th>-->
		...
		<tbody> 
			...
			<tr> <td><input type="checkbox" class="checkbox" data-emp-id="<?php echo e($banner->id); ?>" value="<?php echo e($banner->id); ?>"/></td>
				...
				<td><img height="50px" width="50px" src=<?php echo asset("images/windowdoortype/$banner->image"); ?>></td><td><?php echo e($banner->status); ?></td>
				
				<td><a title="Edit" href="<?php echo e(URL('admin/typeedit',['id' => $banner->id])); ?>"><i class="fas fa-edit"></i></a> &nbsp; <a href="<?php echo e(URL('admin/Window/type',['id' => $banner->id])); ?>" title="Type"><i class="fa fa-window-restore" aria-hidden="true"></i></a> &nbsp; <a href="<?php echo e(URL('admin/Handlelock/list',['id' => $banner->id])); ?>" title="Handle & Lock"><i class="fa fa-lock" aria-hidden="true"></i></a> &nbsp;  <a title="Delete" href="#" data-id = "<?php echo e($banner->id); ?>" class="delete"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
			<?php $i++; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		</tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/Window/typelist.blade.php ENDPATH**/ ?>