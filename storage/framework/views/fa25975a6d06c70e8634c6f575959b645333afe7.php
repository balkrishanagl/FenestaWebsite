...
<?php $__env->startSection('title', ' Testimonials List'); ?>

<?php $__env->startSection('content_header'); ?>
<div class="row">
<div class="col-md-8 text-left">
    <h1 class="m-0 text-dark"> Testimonials List</h1></div>
<div class="col-md-4 text-right">
              <a class="btn btn-primary"  title="Add New" href="<?php echo e(URL::to('/')); ?>/admin/Testimonials"><i class="fa fa-plus"></i> Add New</a>
...
<div class="card-body table-responsive p-0"> 
    <input type="hidden" class="tb" value="testimonials">
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		...
		<tbody>
			...
			<tr>
                ...
                <td><input type="checkbox" class="checkbox" data-emp-id="<?php echo e($testimonial->id); ?>" value="<?php echo e($testimonial->id); ?>"/></td>
				<td><?php echo e($i); ?></td>
				<td><?php echo e($testimonial->name); ?></td>
				<td><?php echo e($testimonial->title); ?></td>
				<td><img height="50px" width="50px" src=<?php echo asset("images/testimonials/user/$testimonial->user_image"); ?>></td>
              <td><?php echo e($category[$testimonial->category]); ?></td>
                <td><?php echo e($testimonial->status); ?></td>
				<td><a title="Edit" href="<?php echo e(URL('admin/editTestimonial',['id' => $testimonial->id])); ?>"><i class="fas fa-edit"></i></a> <a href="javascript:void(0)" title="Delete" data-id = "<?php echo e($testimonial->id); ?>" class="delete"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
			<?php $i++; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		</tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/Testimonials/listTestimonials.blade.php ENDPATH**/ ?>