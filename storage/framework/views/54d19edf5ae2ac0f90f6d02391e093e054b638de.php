...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<?php endif; ?>
			<div class="card-body">
				<?php echo e(Form::model($banner, ['url'  => ['admin/Door/update', $banner->id], 'role'=> 'form','files'=>'true'])); ?>
				...
				<div class="form-group">
					<?php echo e(Form::label('Windowproduct', 'Door Product*')); ?>
    ...
    <br>
                    <?php if($banner->image): ?>
                       <img src="<?php echo e(asset("images/doortype/$banner->image")); ?>" id="category-img-tag" width="150px" />
                    <?php else: ?>
    ...
    <br>
                    <?php if($banner->thumb_image): ?>
                       <img src="<?php echo e(asset("images/doortype/$banner->thumb_image")); ?>" id="category-img-tag1" width="150px" />
                    <?php else: ?>
    ...
    <br>
                    <?php if($banner->featured_image): ?>
                       <img src="<?php echo e(asset("images/doortype/$banner->featured_image")); ?>" id="category-img-tag2" width="150px" />
                    <?php else: ?>
               ...
               <div class="form-group">
                ...
                <div class="preview" >
                    <?php $__currentLoopData = explode(',',$banner->multi_image); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <img src="<?php echo e(asset("images/doortype/$img")); ?>" width="100px">
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <?php else: ?>
...
<br>
                    <?php if($banner->banner_image): ?>
                       <img src="<?php echo e(asset("images/doortype/$banner->banner_image")); ?>" id="category-img-tag4" width="150px" />
                    <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/Door/edit.blade.php ENDPATH**/ ?>