...
<?php $__env->startSection('title', ' Newsletter List'); ?>
...
<?php endif; ?>
<div class="card-body table-responsive p-0"><input type="hidden" class="tb" value="newsletter">
...
<script>
	$(document).ready(function () {
		...
		$('#ok_button').click(function(){
  			$.ajax({
   				url:"deletenewsletter/"+fenestaWorld_id,
   				beforeSend:function(){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/enquiry/newsletter.blade.php ENDPATH**/ ?>