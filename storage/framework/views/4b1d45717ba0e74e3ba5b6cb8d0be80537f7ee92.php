...
<body>
    ...
    <div class="container-fluid">
      <div class="inner-header">
        <div class="logo"><a href="http://52.66.48.39/fenesta_new_develpment/public">
              <img src="http://52.66.48.39/fenesta_new_develpment/public/images/logo/1612952677.png"></a></div>
        <div class="header-right">
          <div class="top">
            <a href="http://52.66.48.39/fenesta_new_develpment/public/brochure"><img class="hover" src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/images/broucher.png"><img class="nohover" src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/images/broucher-white.png">Brochure</a>
            <a data-toggle="modal" data-target=".enquiry-popup" href="javascript:;"><img class="hover" src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/images/enquire.png"><img class="nohover" src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/images/enquire-white.png">Enquire</a>
            <a href="tel:18001029880"><img class="hover" src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/images/phone.png"><img class="nohover" src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/images/phone-white.png">1800 102 9880</a>
          </div>
          <div class="bottom">
            <ul class="menu-list">
              <li><a href="http://52.66.48.39/fenesta_new_develpment/public">Home</a></li>
             <li class="drop-down"><a href="http://52.66.48.39/fenesta_new_develpment/public/about-us">About Us</a>
                
                      <div class="submenu">
                      <ul class="">
                        <li><a href="http://52.66.48.39/fenesta_new_develpment/public/about-us#ourvalue">Our Value</a>

                          </li>
                        <li><a href="http://52.66.48.39/fenesta_new_develpment/public/about-us#infrastructure-sec">Our Infrastructure</a>   
                        </li>
                        <li><a href="http://52.66.48.39/fenesta_new_develpment/public/about-us#awards">Awards &amp; Accreditations</a>   
                        </li>
                      </ul>
                    </div>  
              ...
              <li class="drop-down"><a href="javascript:;">Products</a>
                <div class="submenu">
                  <ul class="">
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/window">Windows</a>
                     
                      </li>
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/door">Doors</a>   
                    </li>
                  </ul>
                </div>  
                ...
                <li class="drop-down"><a href="javascript:;">Why Fenesta</a>
                  <div class="submenu">
                  <ul class="">
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/style-benefits">Style &amp; Benefits</a></li>
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/quality-innovation">Quality &amp; Innovation</a></li>
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/awards-accreditations">Awards &amp; Accreditations</a></li>
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/services-infrastructure">Services &amp; Infrastucture</a></li>
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/brand-heritage">Brand &amp; Heritage</a></li>
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/green-sustainability">Green &amp; Sustainability</a></li>
                  </ul>
                </div>  
                </li>
               <li class="drop-down"><a href="javascript:;">Showcase</a>
                  <div class="submenu">
                  <ul class="">
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/showcase/clientele">Clientele</a></li>
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/showcase/gallery">Gallery</a></li>
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/customer-reviews">Testimonials</a></li>
                  </ul>
                </div>  
                </li>
                  ...
                  <ul class="">
                   <li><a href="https://api.whatsapp.com/send?phone=917428691568&amp;text=Hi">Market Outside India Whatsapp</a></li>
                    <li><a href="sms:+56161&amp;body=Hi">SMS <window> TO 56161</window></a></li>
                       <li><a href="https://www.fenesta.com/campaigns/door_windows/customer-enquiry-form-dec.php?utm_source=WebEnquiry&utm_medium=Organic%2FDirect&utm_campaign=Website" >Submit Enquiry</a></li>
            ...
            <div class="search-box">
              <span class="search-icon" id="searchIcon">
                 <img class="search-image" src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/search.png">
                <img class="mob-search-image" src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/search-blue.png">
              </span>
            </div>
            <div class="mob-locate-icon">
              <img class="" src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/images/locate-icon-blue.png"> Gurugram
 ...
 <style>
  ...
  <div class="main-sec inner-page">
    <div class="switch"><a href="https://www.konverse.ai/"
        ...
        <div class="container-fluid">
          <div class="inner-box">
            <div class="top-footer">
                ...
                <form name="frmNewsletter" id="frmNewsletter" method="post" action="http://52.66.48.39/fenesta_new_develpment/public/newsletter">
                        <input type="hidden" name="_token" value="4rtM8wDqII3xZYHc0fZ0QZHrGexTbBniajAhtVfO">
              ...
              <ul class="social-link">
                 <li><a href="https://www.facebook.com/fenestawindows"><img src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/fb.png"></a></li>
                  <li><a href="https://twitter.com/fenestawindows"><img src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/tweet.png"></a></li>
                  <li><a href="https://www.linkedin.com/company/fenesta-building-systems"><img src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/linked.png"></a></li>
                  <li><a href="https://www.youtube.com/user"><img src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/yt.png"></a></li>
                  <li><a href="https://www.instagram.com/fenestawindows/"><img src="http://52.66.48.39/fenesta_new_develpment/public/images/site_images/insta.png"></a></li>
              </ul>
            </div>
            <div class="footer-menu">
              <div class="footer-menu-box">
                <h6><a href="http://52.66.48.39/fenesta_new_develpment/public/window">Windows <i class="fas fa-plus"></i> <i class="fas fa-minus"></i></a></h6>
                <ul>
                                                                        <li><a href="http://52.66.48.39/fenesta_new_develpment/public/window/upvc-windows">UPVC Windows</a></li>
                                                      <li><a href="http://52.66.48.39/fenesta_new_develpment/public/window/alumininum-window">Alumininum Window</a></li>
                                  </ul>
              </div>
              <div class="footer-menu-box">
                <h6><a href="http://52.66.48.39/fenesta_new_develpment/public/door">Doors <i class="fas fa-plus"></i> <i class="fas fa-minus"></i></a></h6>
                <ul>
                                                          
                                        
                <li><a href="http://52.66.48.39/fenesta_new_develpment/public/door/upvc-doors">UPVC Doors   </a></li>
                                      
                                        
                <li><a href="http://52.66.48.39/fenesta_new_develpment/public/door/alumininum-doors">Alumininum Doors   </a></li>
                                      
                                        
                <li><a href="http://52.66.48.39/fenesta_new_develpment/public/door/internal-doors">Internal Doors   </a></li>
                                   </ul>
              </div>
              <div class="footer-menu-box">
                <h6>Discover Fenesta <i class="fas fa-plus"></i> <i class="fas fa-minus"></i></h6>
                <ul>
                    <li><a href="http://52.66.48.39/fenesta_new_develpment/public/about-us">About Fenesta</a></li>
                  <li><a href="http://52.66.48.39/fenesta_new_develpment/public/about-dcm">DCM Shriram</a></li>
                  <li><a href="http://52.66.48.39/fenesta_new_develpment/public/news-media">News &amp; Media</a></li>
                  <li><a href="http://52.66.48.39/fenesta_new_develpment/public/awards-accreditations">What's New</a></li>
                  <li><a href="http://52.66.48.39/fenesta_new_develpment/public/style-benefits">Why Fenesta</a></li>
                  <li><a href="http://52.66.48.39/fenesta_new_develpment/public/showcase/gallery">Showcase</a></li>
                </ul>
              </div>
              <div class="footer-menu-box">
                <h6>Support <i class="fas fa-plus"></i> <i class="fas fa-minus"></i></h6>
                <ul>
                  <li><a href="http://52.66.48.39/fenesta_new_develpment/public/locate-us">Locate Us  </a></li>
                   <li><a href="http://52.66.48.39/fenesta_new_develpment/public/great-facade">Great Facades </a></li>
                  <li><a href="http://52.66.48.39/fenesta_new_develpment/public/brochure">Request a Brochure  </a></li>
                  <li><a href="javascript:;" data-toggle="modal" data-target=".consult-popup">Consult  </a></li>
                  <li><a href="http://52.66.48.39/fenesta_new_develpment/public/blog">Blog</a></li>
                </ul>
              </div>
              <div class="footer-menu-box">
            ...
            <div class="bottom-footer">
              <ul>
                ...
                <li><a href="http://52.66.48.39/fenesta_new_develpment/public/privacy-policy">Privacy Policies</a></li>
                <li><a href="http://52.66.48.39/fenesta_new_develpment/public/disclaimer"> Disclaimer</a></li>
                <li><a href="javascript:;"> Site Map</a></li>
              </ul>
              <p>  Copyright © 2021 Fenesta Building Systems. All Rights Reserved. </p>
            </div>
          </div>
        </div>
    </footer>
        ...
        <div class="modal-body">          
          <div class="content">
            ...
            <form class="complaint-form" id="complaint-form" novalidate method="post" action="<?php echo e(url('/submit-complaint')); ?>">
              ...
              <div class="form-group">
                <button type="submit" name=""  id="submit-btn-complaint-form" class="blue-btn submitcc"> Submit Complaint</button>
              </div> 
        ...
        <div class="modal-body">          
          <div class="content">
            ...
            <form class="complaint-form" id="complaint-forma" novalidate method="post" action="<?php echo e(url('/submit-complaint')); ?>">
              ...
              <div class="form-group">
                <button type="submit" name=""  id="submit-btn-complaint-forma" class="blue-btn submitcca"> Submit Complaint</button>
              </div>   
...
<?php /**PATH D:\xampp\htdocs\fenestalive\FenestaWebsite\resources\views/errors/404.blade.php ENDPATH**/ ?>