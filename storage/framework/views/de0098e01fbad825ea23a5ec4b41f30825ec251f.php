	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
        ...
        <tbody>
            ...
            ?>
                ...
                <tr> <td><input type="checkbox" class="checkbox" data-emp-id="<?php echo e($data_row->id); ?>" value="<?php echo e($data_row->id); ?>"/></td>
                  <td> <?php echo e($er++); ?></td>
                  <td><?php echo e($data_row->blog_name); ?></td>
                  <td><?php echo e($data_row->name); ?></td>
                  <td><?php echo e($data_row->email); ?></td>               
                  <td><?php echo e($data_row->status); ?></td>
                  ...
                  <a title="Delete " href="<?php echo Request::url();?>?delete=<?php echo $data_row->id;?>" class="delete" onclick="return confirm('Are you sure you want to delete <?php echo e($data_row->name); ?>?');"><i class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/blog-comment/index.blade.php ENDPATH**/ ?>