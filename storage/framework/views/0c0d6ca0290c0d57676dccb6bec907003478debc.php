...
<?php $__env->startSection('title', 'Window By Application'); ?>

<?php $__env->startSection('content_header'); ?>
<div class="row">
<div class="col-md-8 text-left">
    <h1 class="m-0 text-dark"> Window By Application List </h1></div>
<div class="col-md-4 text-right">
              <a class="btn btn-primary" title="Add New" href="<?php echo e(URL::to('/')); ?>/admin/Window/byapplicationadd"><i class="fa fa-plus"></i> Add New</a>
...
<div class="card-body table-responsive p-0">
     <input type="hidden" class="tb" value="windowdoor_byapplications">
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		...
		<tbody>
			...
			<tr> <td><input type="checkbox" class="checkbox" data-emp-id="<?php echo e($banner->id); ?>" value="<?php echo e($banner->id); ?>"/></td>
				<td><?php echo e($i); ?></td>
				<td><?php echo e($banner->title); ?></td><td><?php echo e($banner->status); ?></td>
				<td><a title="Edit" href="<?php echo e(URL('admin/Window/byapplicationedit',['id' => $banner->id])); ?>"><i class="fas fa-edit"></i></a> <a href="#" data-id = "<?php echo e($banner->id); ?>" title="Delete" class="delete"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
			<?php $i++; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		</tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/Window/byapplicationlist.blade.php ENDPATH**/ ?>