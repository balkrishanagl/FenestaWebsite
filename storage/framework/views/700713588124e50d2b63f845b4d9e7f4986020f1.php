                ...
                <div class="customer-rev-list retail-slider">
                    ...
                    <div class="heading">
                      ...
                      <div class="right">
                        ...
                        <div class="date"> <?php if($rcus->city!=''): ?> <?php echo e($rcus->city); ?> <?php else: ?> <?php echo e(date("d M Y",strtotime($rcus->created_at))); ?> <?php endif; ?>  <img src="<?php echo e(asset('images/site_images/images/globe.png')); ?>"></div> 
                          
                          
                      </div>
                    </div>
                     <p class="addReadMore showlesscontent"><?php echo e(strip_tags($rcus->description)); ?> </p>
                  </div>
                    <?php
                    $io=$io+1;
              ...
              <div class="project inner-div">
                ...
                <div class="customer-rev-list retail-slider">
                    ...
                    <div class="heading">
                      ...
                      <div class="right">
                        <div class="name"><?php echo e($rcus->name); ?></div>
                        <div class="date"><?php if($rcus->city!=''): ?> <?php echo e($rcus->city); ?> <?php else: ?> <?php echo e(date("d M Y",strtotime($rcus->created_at))); ?> <?php endif; ?>
                             <img src="<?php echo e(asset('images/site_images/images/globe.png')); ?>"> 
                          </div>                      
                      </div>
                    </div>
                    <p class="addReadMore showlesscontent"><?php echo e(strip_tags($rcus->description)); ?> </p>
                ...
                <div class="customer-rev-list testimonials-slider">
                  ...
                  <div class="item" data-aos="fade-right"  <?php if($iot1>1): ?> data-aos-delay=<?php echo e($datadelayt1); ?> <?php endif; ?>  >
                    <div class="image">
                      <img src="<?php echo asset("images/testimonials/reference/$testimonial->reference_image"); ?>">
                         <?php if(!empty($testimonial->youtube_url)): ?>
                      <span class="play" data-video-id="<?php echo e($testimonial->youtube_url); ?>"><img src="<?php echo e(asset('images/site_images/play.png')); ?>"></span> <?php endif; ?>
                    </div>
                    <div class="desc">
                      <div class="pic"><img src="<?php echo asset("images/testimonials/user/$testimonial->user_image"); ?>"></div>
                      <div class="right">
...
<?php echo $__env->make('frontend.layouts.template_page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/frontend/cmspage/customer_reviews.blade.php ENDPATH**/ ?>