...
<?php $__env->startSection('title', 'Door By Application'); ?>

<?php $__env->startSection('content_header'); ?>
<div class="row">
<div class="col-md-8 text-left">
    <h1 class="m-0 text-dark">List of Door By Application </h1></div>
<div class="col-md-4 text-right">
              <a class="btn btn-primary" href="<?php echo e(URL::to('/')); ?>/admin/Door/byapplicationadd">Add New</a>
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		...
		<tbody>
			...
			<tr> <td><input type="checkbox" class="checkbox" data-emp-id="<?php echo e($banner->id); ?>" value="<?php echo e($banner->id); ?>"/></td>
				...
				<td><a href="<?php echo e(URL('admin/Door/byapplicationedit',['id' => $banner->id])); ?>"><i class="fas fa-edit"></i></a> <a href="#" data-id = "<?php echo e($banner->id); ?>" class="delete"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
			<?php $i++; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		</tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/Door/byapplicationlist.blade.php ENDPATH**/ ?>