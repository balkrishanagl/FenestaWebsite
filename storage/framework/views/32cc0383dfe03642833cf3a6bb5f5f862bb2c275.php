<?php $__env->startSection('title', 'Add Shworoom'); ?>

<?php $__env->startSection('content_header'); ?>
<script src="https://cdn.ckeditor.com/ckeditor5/23.0.0/classic/ckeditor.js"></script>
<h1 class="m-0 text-dark">Add Shworoom</h1>
...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<?php endif; ?>
			<div class="card-body">
				<?php echo e(Form::open(array('url' => 'admin/saveShowroom','files' => true))); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/LocateUs/addShowroom.blade.php ENDPATH**/ ?>