                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <?php $__currentLoopData = Config::get('constants.CONS_STATUS_ARRAY'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>:
                          ...
                          <option value="<?php echo e($key); ?>" <?php echo e((isset($_GET['status']) && $_GET['status']==$key)?'selected="selected"':''); ?> ><?php echo e($val); ?></option>
   ...
   <div class="card-body table-responsive p-0">
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
        ...
        <tbody>
                ...
                <tr>
                  <td> <?php echo e($data_row->id); ?></td>
                  <td> <?php echo e($data_row->name); ?></td>
                  <td><?php echo e($data_row->slug); ?></td>
                 
            <td><span class="label label-<?php echo ($data_row->status=='1')?'success':'danger';?>">
                   <?php echo e(Config::get('constants.CONS_STATUS_ARRAY')[$data_row->status]); ?></span></td>
                  <td><?php echo e($data_row->created_at->format('F j, Y')); ?></td>
                   <td><?php echo e($data_row->updated_at->format('F j, Y')); ?></td>
                    
                  <td>
                  <a href="<?php echo Request::url();?>/view/<?php echo $data_row->id;?>" class="btn bg-olive ">View</a>
                  <a href="<?php echo Request::url();?>?delete=<?php echo $data_row->id;?>" class="btn bg-red  " onclick="return confirm('Are you sure you want to delete <?php echo e($data_row->title); ?>?');">Delete</a>
                  </td>
                </tr>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/blog-tag/index.blade.php ENDPATH**/ ?>