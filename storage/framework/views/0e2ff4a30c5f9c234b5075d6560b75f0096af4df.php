<?php $__env->startSection('title', 'Add Fenesta World'); ?>
...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<?php endif; ?>
			<div class="card-body">
				<?php echo e(Form::open(array('url' => 'admin/saveFenestaWorld','files' => true))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/FenestaWorld/addFenestaWorld.blade.php ENDPATH**/ ?>