...
<?php $__env->startSection('title', ' Enquiries List'); ?>

<?php $__env->startSection('content_header'); ?>
<h1 class="m-0 text-dark"> Enquiries List</h1>
...
<?php endif; ?>
<div class="card-body table-responsive p-0"> <input type="hidden" class="tb" value="lp_leads">
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		...
		<tbody>
			...
			<tr>
<td><input type="checkbox" class="checkbox" data-emp-id="<?php echo e($fenestaWorlds->id); ?>" value="<?php echo e($fenestaWorlds->id); ?>"/></td>

				<td><?php echo e($i); ?></td>
				<td><?php echo e($fenestaWorlds->name); ?></td>
				<td><?php echo e($fenestaWorlds->email); ?></td>
				<td><?php echo e($fenestaWorlds->phone); ?></td>
				<td><?php if($fenestaWorlds->verifyOtp==0): ?> Not Verified <?php else: ?> OTP Verified <?php endif; ?></td>
				<td><?php echo e($fenestaWorlds->city); ?></td>
				<td><?php echo e(date("d, M Y",strtotime($fenestaWorlds->cur_time))); ?></td>
                <td><?php echo e($fenestaWorlds->utm_source); ?></td>
                <td><?php echo e($fenestaWorlds->device); ?></td>
...
<script>
	$(document).ready(function () {
		...
		$('#ok_button').click(function(){
  			$.ajax({
   				url:"deleteleadsenquiries/"+fenestaWorld_id,
   				beforeSend:function(){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/enquiry/enquiries.blade.php ENDPATH**/ ?>