<?php $__env->startSection('title', 'Add Door Type'); ?>

<?php $__env->startSection('content_header'); ?>
<h1 class="m-0 text-dark">Add Door Type </h1>
...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<?php endif; ?>
			<div class="card-body">
				<?php echo e(Form::open(array('url' => 'admin/Door/save','files' => true))); ?><div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/Door/add.blade.php ENDPATH**/ ?>