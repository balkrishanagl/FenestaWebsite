  ...
  <style> 
      .switch a{
       ...
       <?php if(empty($banner_image)): ?>
        ...
        <div class="switch"><a href="<?php echo e(url('/windows')); ?>"> <img src="<?php echo e(asset('images/site_images/door-icon.png')); ?>"> Switch to <br> Windows</a></div>
        ...
        <div class="container-fluid">
          <div class="product-by-appl-tab" data-aos="fade-up">
            <ul class="application-tab-list">
              ...
              <li><a href="#<?php echo e(trim($bav->title)); ?>" <?php if($bak==0): ?> class="active" <?php endif; ?> ><?php echo e($bav->title); ?></a></li>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
            <div class="product-by-appl-tab-list">
                <?php $__currentLoopData = $byapplication; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bak => $bav): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
              <div class="product-by-appl-tab-box" id="<?php echo e(trim($bav->title)); ?>" <?php if($bak==0): ?>  style="display: block;" <?php endif; ?>  >
...
<?php echo $__env->make('frontend.layouts.template_page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/frontend/doors/doors.blade.php ENDPATH**/ ?>