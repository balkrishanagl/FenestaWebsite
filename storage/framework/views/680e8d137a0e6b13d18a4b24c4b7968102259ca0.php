...
<?php $__env->startSection('title', ' Customer Complaints List'); ?>

<?php $__env->startSection('content_header'); ?>
<h1 class="m-0 text-dark"> Customer Complaints List </h1>
...
<?php endif; ?>
<div class="card-body table-responsive p-0"> <input type="hidden" class="tb" value="enquiries">
...
<td><input type="checkbox" class="checkbox" data-emp-id="<?php echo e($fenestaWorlds->id); ?>" value="<?php echo e($fenestaWorlds->id); ?>"/></td>
				...
				<td><?php echo e($fenestaWorlds->state); ?></td>
				<td><?php echo e($fenestaWorlds->city); ?></td>
				<td><?php echo e($fenestaWorlds->address); ?></td>
				<td><?php echo e($fenestaWorlds->message); ?></td>
				<td><?php echo e(date("d, M Y",strtotime($fenestaWorlds->created_at))); ?></td><td><?php echo e($fenestaWorlds->ip); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/enquiry/customercomplaint.blade.php ENDPATH**/ ?>