...
<?php $__env->startSection('title', ' Trim Option List'); ?>

<?php $__env->startSection('content_header'); ?>
<div class="row">
<div class="col-md-8 text-left">
    <h1 class="m-0 text-dark"> Trim  Option List</h1></div>
<div class="col-md-4 text-right">
              <a class="btn btn-primary" title="Add New" href="<?php echo e(URL::to('/')); ?>/admin/Trim"><i class="fa fa-plus"></i> Add New</a>
...
<?php endif; ?>
<div class="card-body table-responsive p-0">  <input type="hidden" class="tb" value="trim_options">
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		...
		<tbody>
			...
			<tr><td><input type="checkbox" class="checkbox" data-emp-id="<?php echo e($newz->id); ?>" value="<?php echo e($newz->id); ?>"/></td>
				...
				<td>
                    <?php if($newz->type=='Single'): ?>
                    <img height="50px" width="50px" src=<?php echo asset("images/trim/$newz->image"); ?>>
                    <?php else: ?>
                     <?php $__currentLoopData = explode(',',$newz->image); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <img height="50px" width="50px" src=<?php echo asset("images/trim/$mm"); ?>>
                      
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                </td>
                <td><?php echo e($newz->type); ?> Image</td>
                <td><?php echo e($newz->status); ?> </td>
				<td><a title="Edit" href="<?php echo e(URL('admin/editTrim',['id' => $newz->id])); ?>"><i class="fas fa-edit"></i></a> <a href="#" data-id = "<?php echo e($newz->id); ?>" title="Delete" class="delete"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
			<?php $i++; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		</tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/Trim/listTrim.blade.php ENDPATH**/ ?>