...
<div class="col-md-8 text-left">
    <h1 class="m-0 text-dark"> Blog Categories List </h1></div>
...
<?php endif; ?>
   ...
   <div class="card-body table-responsive p-0"><input type="hidden" class="tb" value="blog_category">
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		<thead>
            ...
            <td><span class="label label-<?php echo ($data_row->status=='1')?'success':'danger';?>">
                ...
                <?php echo e($data_row->status); ?></span></td>
                              
                  <td><?php echo e($data_row->created_at->format('F j, Y')); ?></td>
                 
                    
                  <td>
                  <a href="<?php echo Request::url();?>/view/<?php echo $data_row->id;?>"  title="Edit " ><i class="fas fa-edit"></i></a>
                  <a href="<?php echo Request::url();?>?delete=<?php echo $data_row->id;?>" title="Delete " class="delete " onclick="return confirm('Are you sure you want to delete <?php echo e($data_row->title); ?>?');"><i class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/blog-category/index.blade.php ENDPATH**/ ?>