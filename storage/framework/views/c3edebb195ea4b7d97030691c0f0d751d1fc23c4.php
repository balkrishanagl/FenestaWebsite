...
<?php $__env->startSection('js'); ?>
	<script>
     var urla = "<?php echo e(url('/')); ?>/admin/editgetstate";//should return json with a list of cities only 
        var id = "<?php echo e($showroom->state); ?>";
        var data = {'id':id};
         $.ajax({
        url:urla, 
          data:data,
        ...
        success: function(items){
            $('#state').html(items);
             ...
             $('#state').change(function(){
                ...
                var id = "<?php echo e($showroom->city); ?>";
            //    alert(std);
...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			<?php endif; ?>
			<div class="card-body">
				<?php echo e(Form::model($showroom, ['url'  => ['admin/updateShowroom', $showroom->id], 'role'=> 'form','files'=>'true'])); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/LocateUs/editShowroom.blade.php ENDPATH**/ ?>