...
<div class="col-md-8 text-left">
    <h1 class="m-0 text-dark"> Pages List </h1></div>
<div class="col-md-4 text-right">
    <a class="btn btn-primary" title="Add New" href="<?php echo e(URL::to('/')); ?>/admin/addPage"><i class="fa fa-plus"></i> Add New</a>
...
<?php endif; ?>
<div class="card-body table-responsive p-0"> <input type="hidden" class="tb" value="pages">
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		...
		<tbody>
			...
			<tr><td><input type="checkbox" class="checkbox" data-emp-id="<?php echo e($page->id); ?>" value="<?php echo e($page->id); ?>"/></td>
				<td><?php echo e($i); ?></td>
				
				<td><?php echo e($page->page_title); ?></td>
				
				<td><img  width="200px" src=<?php echo asset("images/$page->banner_image"); ?>></td>
				<td><?php echo e($page->status); ?></td>
				<td><a title="Edit <?php echo e($page->page_title); ?>" href="<?php echo e(URL('admin/editPage',['id' => $page->id])); ?>"><i class="fas fa-edit"></i></a> <a href="#" title="Delete <?php echo e($page->page_title); ?>" data-id = "<?php echo e($page->id); ?>" class="delete"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
			<?php $i++; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		</tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/admin/listPage.blade.php ENDPATH**/ ?>