...
<html lang="en">
<head>
    <?php if(!empty($childslug_formeta)): ?>
    <?php if($childslug_formeta=='signature-studio'): ?> 
    
         <?php if(!empty($child_slug1) and empty($child_slug2)): ?>
             <?php $mc_title =  $child_slug1; ?>
    
          <title>Signature Studios & Offices in <?php echo e($mc_title); ?> - Fenesta</title>
          <meta charset="utf-8">
          <meta name="description" content="Visit the Fenesta Signature Studios or Offices to buy uPVC & Aluminum Windows and Doors in <?php echo e($mc_title); ?>. To expolre all kinds of doors and windows in <?php echo e($mc_title); ?> at ✅ best quality and ✅ price, ✅ Call us @ 1800-102-9880.">
          <meta name="keywords" content="Signature Studios & Offices in <?php echo e($mc_title); ?> - Fenesta" />
    
         <?php elseif(!empty($child_slug1) and !empty($child_slug2) and empty($child_slug3)): ?>
              <?php $mc_title =  $child_slug2; ?>
         ...
         <?php elseif(!empty($child_slug1) and !empty($child_slug2) and !empty($child_slug3)): ?>
                <?php 
                $mc_title =  $child_slug2;
                $mc_title1 =  $child_slug3;
                ?>
    
          <title>Signature Studios & Offices in <?php echo e($mc_title1); ?> | <?php echo e($mc_title); ?> - Fenesta</title>
          <meta charset="utf-8">
          <meta name="description" content="Visit the Fenesta Signature Studios or Offices to buy uPVC & Aluminum Windows and Doors in <?php echo e($mc_title1); ?> , <?php echo e($mc_title); ?>. To expolre all kinds of doors and windows in <?php echo e($mc_title1); ?>,<?php echo e($mc_title); ?> at ✅ best quality and ✅ price, ✅ Call us @ 1800-102-9880.">
          <meta name="keywords" content="Signature Studios & Offices in <?php echo e($mc_title1); ?> | <?php echo e($mc_title); ?> - Fenesta" />
    
         <?php else: ?>
    
          <title>Signature Studios & Offices | Windows & Doors - Fenesta</title>
          <meta charset="utf-8">
          <meta name="description" content="Visit the Fenesta Signature Studios or Offices to buy uPVC & Aluminum Windows and Doors in India. To expolre all kinds of doors and windows in India at ✅ best quality and ✅ price, ✅ Call us @ 1800-102-9880.">
          <meta name="keywords" content="Signature Studios & Offices | Windows & Doors - Fenesta" />
    
         <?php endif; ?>
    
    <?php elseif($childslug_formeta=='partner-showroom'): ?> 
         <?php if(!empty($child_slug1) and empty($child_slug2) and empty($child_slug3)): ?>
             <?php $mc_title =  $child_slug1; ?>
    
          <title>uPVC & Aluminium Windows & Doors in <?php echo e($mc_title); ?>| Dealer Showroom in <?php echo e($mc_title); ?> - Fenesta</title>
          <meta charset="utf-8">
          <meta name="description" content="Visit the uPVC & Aluminium doors & windows dealers, suppliers showroom in <?php echo e($mc_title); ?>. To design all kinds of doors and windows in <?php echo e($mc_title); ?> at ✅best quality and ✅ price, ✅ Call us @ 1800-102-9880.">
          <meta name="keywords" content="uPVC & Aluminium Windows & Doors in <?php echo e($mc_title); ?>| Dealer Showroom in <?php echo e($mc_title); ?> - Fenesta" />
         <?php elseif(!empty($child_slug1) and !empty($child_slug2) and empty($child_slug3)): ?>
              <?php $mc_title =  $child_slug2; ?>
         ...
         <?php elseif(!empty($child_slug1) and !empty($child_slug2) and !empty($child_slug3)): ?>
              <?php $mc_title =  $child_slug2;  $mc_title1 =  $child_slug3; ?>
    
          <title>uPVC & Aluminium Windows & Doors in <?php echo e($mc_title1); ?> , <?php echo e($mc_title); ?>| Dealer Showroom in <?php echo e($mc_title1); ?> , <?php echo e($mc_title); ?> - Fenesta</title>
          <meta charset="utf-8">
          <meta name="description" content="Visit the uPVC & Aluminium doors & windows dealers, suppliers showroom in <?php echo e($mc_title1); ?> , <?php echo e($mc_title); ?>. To design all kinds of doors and windows in <?php echo e($mc_title1); ?> , <?php echo e($mc_title); ?> at ✅best quality and ✅ price, ✅ Call us @ 1800-102-9880.">
          <meta name="keywords" content="uPVC & Aluminium Windows & Doors in <?php echo e($mc_title1); ?> , <?php echo e($mc_title); ?>| Dealer Showroom in <?php echo e($mc_title1); ?> , <?php echo e($mc_title); ?> - Fenesta" />
    
         <?php else: ?>
    
          <title>Locate uPVC & Aluminium Windows & Doors Dealers Showroom in India - Fenesta</title>
          <meta charset="utf-8">
          <meta name="description" content="Find here nearest Fenesta dealer showroom & suppliers in India. ✅Get contact details & address of dealers.">
          <meta name="keywords" content="Locate uPVC & Aluminium Windows & Doors Dealers Showroom in India - Fenesta" />
    
         <?php endif; ?>
    
    <?php elseif($childslug_formeta=='international-market'): ?> 
         <?php if(!empty($child_slug1) and empty($child_slug2)): ?>
             <?php $mc_title =  $child_slug1; ?>
    
          <title>UPVC & Aluminium Windows & Doors in <?php echo e($mc_title); ?> | Dealers Showroom - Fenesta</title>
          <meta charset="utf-8">
          <meta name="description" content="Visit the Aluminium uPVC doors & windows dealers, suppliers showroom in <?php echo e($mc_title); ?>. ✅call us at 1800-102-9880 to know more about design all kinds of doors and windows in <?php echo e($mc_title); ?> with ✅best quality and ✅price.">
          <meta name="keywords" content="UPVC & Aluminium Windows & Doors in <?php echo e($mc_title); ?> | Dealers Showroom - Fenesta" />
         <?php elseif(!empty($child_slug1) and !empty($child_slug2)): ?>
              <?php $mc_title =  $child_slug2; ?>
    
          <title>UPVC Windows & Doors in <?php echo e($mc_title); ?> | Dealers Showroom - Fenesta</title>
          <meta charset="utf-8">
          <meta name="description" content="Visit the Aluminium uPVC doors & windows dealers, suppliers showroom in <?php echo e($mc_title); ?>. ✅call us at 1800-102-9880 to know more about design all kinds of doors and windows in <?php echo e($mc_title); ?> with ✅best quality and ✅price.">
          <meta name="keywords" content="UPVC Windows & Doors in <?php echo e($mc_title); ?> | Dealers Showroom - Fenesta" />
    
         <?php else: ?>
    
           <title>Locate International Offices - Fenesta</title>
          <meta charset="utf-8">
          <meta name="description" content="Fenesta is starting uPVC windows & Doors Business in International market with several dealers, distributor, and showrooms across the world. Call 1800 102 9880 for any assistance.">
          <meta name="keywords" content="Locate International Offices - Fenesta" />
    ...
    <?php endif; ?> 
        ...
        <?php if($childslug_formeta=='fenesta-offices'): ?> 
          <?php if($childslug_formeta=='fenesta-offices' and !empty($child_slug1)): ?> 
            <?php if($child_slug1==1): ?>
                  <title>Head Office in Gurgaon - Fenesta</title>
                  <meta charset="utf-8">
                  <meta name="description" content="Fenesta have their head office in Guragaon. Go and visit here to know the latest premium collection of upvc windows & doors or call 18001029880 for any assistance.">
                  <meta name="keywords" content="Head Office in Gurgaon - Fenesta" />

            <?php elseif($child_slug1==2): ?>
            <title>Locate Sales Office & Installation Service - Fenesta</title>
                  <meta charset="utf-8">
                  <meta name="description" content="Fenesta have their sales and installation offices in Ahmedabad, Banglore, Chennai and many other cities in India. Call 1800 102 9880 for any assistance.">
                  <meta name="keywords" content="Locate Sales Office & Installation Service - Fenesta" />

            <?php elseif($child_slug1==3): ?>
            <title>Contact Extrusion Factory - Fenesta</title>
                  <meta charset="utf-8">
                  <meta name="description" content="Fenesta owns extrusion factory in Kota and manufactures supreme quality UPVC doors and windows. Call 1800 102 9880 for any queries,concerns.">
                  <meta name="keywords" content="Contact Extrusion Factory - Fenesta" />

            <?php elseif($child_slug1==4): ?>
            <title>Fabrication Factories - Fenesta</title>
                  <meta charset="utf-8">
                  <meta name="description" content="Fenesta has extrusion fabrication factories in Bhiwadi, Chennai, Hyderabad and manufactures supreme quality UPVC doors and windows. Call 1800 102 9880 for any queries,concerns.">
                  <meta name="keywords" content="Fabrication Factories - Fenesta" />

            <?php endif; ?>
          <?php else: ?>
    
          <title>Locate Offices in India - Fenesta</title>
          <meta charset="utf-8">
          <meta name="description" content="Fenesta has their head office in Gurgaon along with several dealers, distributor, and showrooms across India. Call 1800 102 9880 for any assistance.">
          <meta name="keywords" content="Locate Offices in India - Fenesta" />
          <?php endif; ?>
        <?php endif; ?>   
    
    <?php elseif(!empty($page_slug)): ?>
       <?php if($page_slug=='features-benefits' and !empty($featurebenefitsingle)): ?>
    		
          <title><?php echo e($featurebenefitsingle->meta_title); ?></title>
          <meta charset="utf-8">
          <meta name="description" content="<?php echo e($featurebenefitsingle->meta_description); ?>">
          <meta name="keywords" content="<?php echo e($featurebenefitsingle->meta_keyword); ?>" />
...
<!-- End UET tag --><!-- Facebook Pixel Code -->
<script>
...
<!-- End Facebook Pixel Code -->
  ...
  <?php if(!empty($id)): ?>  
  <?php if($id==45): ?>  
    <!-- Event snippet for Fenesta-Pixels conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-1026052676/DgQvCO3pyHkQxKSh6QM'});
</script>
    <?php endif; ?>
    <?php endif; ?>
...
<!-- Breadcrumb Schema Code -->
    <?php elseif(count(Request::segments()) == 2): ?>
      <!-- Breadcrumb Schema Code -->
      <?php
       $s_title = '';
     ?>
    ...
    <script type="application/ld+json">
          ...
          {
          "@id": "<?php echo e(url('/')); ?>/<?php echo e(Request::segment(1)); ?>",
          "name": "<?php echo e($s_title); ?>"
          }
          },
          {
          "@type": "ListItem",
    ...
    <?php elseif(count(Request::segments()) == 3): ?>
      <!-- Breadcrumb Schema Code -->
        <?php
         $s_title = '';
         $s_title1 = '';
      ...
      <script type="application/ld+json">
      {
        ...
        "item":
        {
        "@id": "<?php echo e(url('/')); ?>/<?php echo e(Request::segment(2)); ?>",
        "name": "<?php echo e($s_title1); ?>"
        }
        },
        {
        "@type": "ListItem",
        ...
        <div class="modal-body">          
          <div class="content">
            ...
            <form class="enquiry-form" id="enquiry-form" action="<?php echo e(url('/submit-enquiry')); ?>" method="post" novalidate>
              ...
              <div class="form-group">
                <select class="form-control seledrop  userstate" id="userstate" name="state">
              ...
              <div class="form-group">
                <select class="form-control seledrop  usercity" id="usercity" name="city">
...
<?php
   $useragent=$_SERVER['HTTP_USER_AGENT'];
        ...
        { 
           ?>
<div class="whatapp_wrap_box" id="whatapp_wrap_box">
...
jQuery("#"+form_id+" .error").html(" ");  
   ...
   if(userphone==''){        
    ...
    var chkval =  $(".checkboxcls").is(':checked');
//     alert(chkval);
     if(chkval == false){ 

        jQuery(".message-error-box-brochure").html('Please select any brochure.').delay(5000).fadeOut();
        jQuery(".message-error-box-" + form_id).show();
        return false;
     }
                        ...
                        jQuery.each(a, function(e, a) {
                          // alert(a);
                           //alert(e);
                            ...
                            jQuery(".message-error-box-brochure").html(a.message).delay(5000).fadeOut();;
...
//        r.preventDefault();
    ...
    if ( $('#consult_recaptcha').length ) {
       ...
       $('.submitexpert').prop("disabled", true);
       // ajax
             jQuery.ajax({ 
...
<?php /**PATH D:\xampp\htdocs\fenestalive\FenestaWebsite\resources\views/frontend/layouts/template_page.blade.php ENDPATH**/ ?>