            ...
            <div class="left-col">              
              ...
              <div class="pagination">
                ...
                <?php if(App\Models\BlogPostModel::getPostPrv($post_data->id)!=''){?>
                    ...
                    <a href="<?php echo e(App\Models\BlogPostModel::getPostUrl(App\Models\BlogPostModel::getPostPrv($post_data->id)->slug)); ?>" class="white-btn prev"> Prev
                    </a>
                
                <?php } ?>
                 
                <?php if(App\Models\BlogPostModel::getPostNaxt($post_data->id)!=''){?>
                    <a href="<?php echo e(App\Models\BlogPostModel::getPostUrl(App\Models\BlogPostModel::getPostNaxt($post_data->id)->slug)); ?>" class="white-btn next">Next
                    </a>
                  <?php } ?>
                ...
                <div class="social-link">
                  ...
                  <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(App\Models\BlogPostModel::getPostUrl($post_data->slug)); ?>"><img src="<?php echo e(asset('images/site_images/fb.png')); ?>"></a>
                  <a target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo e($post_data->page_title); ?>&amp;url=<?php echo e(App\Models\BlogPostModel::getPostUrl($post_data->slug)); ?>"><img src="<?php echo e(asset('images/site_images/tweet.png')); ?>"></a>
                  <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo e(App\Models\BlogPostModel::getPostUrl($post_data->slug)); ?>&amp;title=<?php echo e($post_data->page_title); ?>"><img src="<?php echo e(asset('images/site_images/linked.png')); ?>" ></a>
                 
                  <a href="https://www.instagram.com/?url=<?php echo e(App\Models\BlogPostModel::getPostUrl($post_data->slug)); ?>" target="_blank"><img src="<?php echo e(asset('images/site_images/insta-icon.png')); ?>"></a>
                </div>
              </div>
...
<?php echo $__env->make('frontend.layouts.template_page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/fenesta_new_develpment/resources/views/frontend/blog/blog_detail.blade.php ENDPATH**/ ?>