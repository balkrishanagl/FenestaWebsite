            ...
            <div class="row">
              <div class="col-md-12">
                <div class="box">
                  ...
                  <div class="col-xs-4">
                        <label>List</label>
                        <select name="list_id" id="category_id"  class="form-control select select2">
                      <option value=""></option>
                          <?php foreach ($lists as $list) { ?>
                             <option value="<?php echo $list->id;?>"  <?php echo (isset($_GET['list_id']) && $_GET['list_id']==$list->id)?'selected':'';?>><?php echo $list->name;?> 
                              </option>
                  ...
                  <div class="box-body">
                    <div class="row filter-input">
                     ...
                     <div class="col-xs-2">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="" value="<?php echo (isset($_GET['name']))?$_GET['name']:'';?>">
                      </div>  
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  <td> {{ $data_row->id }}</td>
                  <td> {{ $data_row->name }}</td>               
                  <td>{{ $data_row->pack_size }}</td>
                  <td>{{ $data_row->old_mrp }}</td>
                  <td>{{ $data_row->revised_mrp }}</td>
                    ...
                    <td> 
                      @if(App\RevisedListModel::find($data_row->list_id))
                      {{ App\RevisedListModel::find($data_row->list_id)->name }}
                    @endif</td>
