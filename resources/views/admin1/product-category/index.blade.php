          ...
          <div class="box">
                  ...
                  <div class="box-body">
                    <div class="row filter-input">
                     ...
                     <div class="col-xs-2">
                        ...
                        <input type="text" class="form-control" id="cat_name" name="cat_name" placeholder="Name" value="<?php echo (isset($_GET['cat_name']))?$_GET['cat_name']:'';?>">
                      </div>  
                      ...
                      <option value=""></option>
                          <?php foreach ($parent_categorys as $category) { ?>
                             <option value="<?php echo $category->id;?>"  <?php echo (isset($_GET['parent_id']) && $_GET['parent_id']==$category->id)?'selected':'';?>><?php echo $category->cat_name;?> 
                              </option>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  <td> {{ $data_row->id }}</td>
                  <td> {{ $data_row->cat_name }}</td>
                  <td> 
                    @if($data_row->parent_id)
                    {{ App\ProductCategoryModel::find($data_row->parent_id)->cat_name }}
                    @endif
                  </td>
            ...
            <td><span class="label label-<?php echo ($data_row->status=='1')?'success':'danger';?>">
                  ...
                  <a href="<?php echo Request::url();?>?delete=<?php echo $data_row->id;?>" class="btn bg-red  " onclick="return confirm('Are you sure you want to delete {{$data_row->cat_name}}?');">Delete</a>
                  </td>
                </tr>
               @endforeach
