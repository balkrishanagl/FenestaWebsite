             ...
             <input type="hidden" required="" name="id" value="{{ (isset($data_row->id))?$data_row->id:'' }}">
              ...
              <div class="box-body">
                 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Perent Category</label>        
                  <div class="col-sm-10">                   
                <select name="parent_id" class="form-control select">
        
                           <option value="0"></option>
                           <?php foreach ($parent_categorys as $key => $category) { ?>
                             <option value="<?php echo $category->id;?>" <?php echo (isset($data_row['parent_id']) && $data_row['parent_id']==$category->id)?'selected':'';?>><?php echo $category->name;?></option>
