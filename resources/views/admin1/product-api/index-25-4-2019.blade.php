...
@section('content')
     ...
     */ ?>
                     ...
                     <div class="col-xs-2">
                        ...
                        <input type="text" class="form-control" id="active_ingredient" name="active_ingredient" placeholder="" value="<?php echo (isset($_GET['active_ingredient']))?$_GET['active_ingredient']:'';?>">
                      </div>  

                      <div class="col-xs-2">
                        <label>CAS No.</label>
                        <input type="text" class="form-control" id="cas_no" name="cas_no" placeholder="" value="<?php echo (isset($_GET['cas_no']))?$_GET['cas_no']:'';?>">
                      </div> 
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  <td> {{ $data_row->id }}</td>
                  <td> {{ $data_row->active_ingredient }}</td>
                  <td>{{ $data_row->cas_no }}</td>
