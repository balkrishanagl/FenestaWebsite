             ...
             <input type="hidden" required="" name="id" value="{{ (isset($data_row->id))?$data_row->id:'' }}">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Active Ingredient</label>
                  <div class="col-sm-10">
                    <input type="text" required="" class="form-control get_url_name" id="active_ingredient" name="active_ingredient" value="{{ (isset($data_row->active_ingredient))?$data_row->active_ingredient:old('active_ingredient') }}">
                  </div>
                </div>
                  

                  <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">CAS no</label>
                  <div class="col-sm-10">
                    <input type="text" required="" class="form-control get_url_name" id="cas_no" name="cas_no" value="{{ (isset($data_row->cas_no))?$data_row->cas_no:old('cas_no') }}">
                  </div>
                </div>
