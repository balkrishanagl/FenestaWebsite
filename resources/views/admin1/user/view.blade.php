             ...
             <input type="hidden" required="" name="id" value="<?php echo isset($data_row['id'])?$data_row['id']:'';?>">
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="email"  class="form-control" id="email" name="email" value="<?php echo isset($data_row['email'])?$data_row['email']:'';?>" required>
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">                				
					...
					<option value="0" <?php echo (isset($data_row['status']) && $data_row['status']==0)?'selected':'';?>>Inactive</option>				
				       ...
				       <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Set New Password</label>
                  <div class="col-sm-10">
