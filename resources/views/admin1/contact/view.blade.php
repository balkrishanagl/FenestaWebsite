    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <form class="form-horizontal" method="POST" action="<?php echo url(ADMIN_FOLDER);?>/<?php echo $page_name;?>/save" enctype="multipart/form-data">
             ...
             <input type="hidden" required="" name="id" value="<?php echo isset($data_row['id'])?$data_row['id']:'';?>">
              ...
              <div class="box-body">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" readonly=""  class="form-control" id="page_type" name="page_type" value="<?php echo isset($data_row['page_type'])?$data_row['page_type']:'';?>">
                  </div>
          </div>
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text"  class="form-control" id="mobile" name="mobile" value="<?php echo isset($data_row['mobile'])?$data_row['mobile']:'';?>">
                  </div>
          </div>
          ...
          @if($data_row->page_type=='Quick Query')
           <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Location</label>

                  <div class="col-sm-10">
            <textarea class="form-control"  name="location" ><?php echo isset($data_row['location'])?$data_row['location']:'';?></textarea>            
