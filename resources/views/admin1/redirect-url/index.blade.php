                  ...
                  <div class="box-body">
                    <div class="row filter-input">                    
                     ...
                     <div class="col-xs-2">
                        ...
                        <input type="text" class="form-control" id="from_url" name="from_url" placeholder="Name" value="<?php echo (isset($_GET['from_url']))?$_GET['from_url']:'';?>">
                      </div>  


                      <div class="col-xs-2">
                        <label>To Url</label>
                        <input type="text" class="form-control" id="to_url" name="to_url" placeholder="to_url" value="<?php echo (isset($_GET['slug']))?$_GET['to_url']:'';?>">
                      </div> 
