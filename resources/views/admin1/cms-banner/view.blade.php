    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <form class="form-horizontal" method="POST" action="<?php echo url(ADMIN_FOLDER);?>/<?php echo $page_name;?>/save" enctype="multipart/form-data">
         ...
         <p class="help-block">Awards Image Size :544 X 531 </p>
         <p class="help-block">Recognition and Appreciation Image Size :290 X 290 </p>
         <p class="help-block">Latest Innovative Image Size :601 X 360 </p>
         <p class="help-block">Our Lighting Image Size :601 X 360 </p>
         <p class="help-block">LiFi Gallery Image Size :1529 X 747 </p>
                  </div>
                </div>
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <option value="{{ $key }}"   {{ $selected }}  >
                 ...
                 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Link Url or Youtube Video Url</label>
                  <div class="col-sm-10">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
          <?php if(isset($data_row['download_file']) && $data_row['download_file']!=''){?>
                    
                    <a href="{{ URL::asset('public/') }}/{{  $data_row->download_file }}" download="" class="know-link">Download Brochure</a>
          <br/> Delete <input type="checkbox" name="downloads_delete" value="1">
          <?php } ?>
          <input type="file" name="download_file" id="download_file" accept=".pdf">
                  </div>
                </div>
