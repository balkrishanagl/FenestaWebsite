        ...
        <form class="form-horizontal" method="POST" action="<?php echo url(ADMIN_FOLDER);?>/<?php echo $page_name;?>/save" enctype="multipart/form-data">
             ...
             <input type="hidden" required="" name="id" value="{{ (isset($data_row->id))?$data_row->id:'' }}">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" required="" class="form-control get_url_name" id="qsn" name="qsn" value="{{ (isset($data_row->qsn))?$data_row->qsn:old('qsn') }}">
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                  <textarea class="form-control " id="ans" name="ans">{{ (isset($data_row->ans))?$data_row->ans:old('ans') }}</textarea>       
             ...
             <div class="form-group">
                  ...
                  <select name="type" class="form-control select" required  >          
                        @foreach ( Config::get('constants.CONS_FAQ_TYPE_ARRAY')  as $key =>$val)
                            <?php 
                              $selected='';
