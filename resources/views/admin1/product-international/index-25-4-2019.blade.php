...
@section('content')
     ...
     */ ?>
                     ...
                     <select name="maincategory_id" class="form-control select"   >  
                      <option value=""></option>        
                        @foreach ( Config::get('constants.CONS_MAINCATEGORY_ARRAY')  as $key =>$val)
                            <?php 
                              $selected='';
                              if(isset($_GET['maincategory_id']) && $_GET['maincategory_id']==$key){
                                $selected='selected';
                              }
                            ?>
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td>{{ $data_row->packdetails }}</td>
                    ...
                    <td>
                  <?php if(isset(Config::get('constants.CONS_MAINCATEGORY_ARRAY')[$data_row->maincategory_id])){

                   echo  Config::get('constants.CONS_MAINCATEGORY_ARRAY')[$data_row->maincategory_id];
                  ...
                  ?>
                    ...
                    <td> {{ App\ProductCategoryModel::find($data_row->category_id)->cat_name }}</td>
