                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    <div class="row filter-input">
                     ...
                     <div class="col-xs-3">
                        <label>Title</label>
                        <input type="text" class="form-control" id="title" name="title" placeholder="Title" value="<?php echo (isset($_GET['title']))?$_GET['title']:'';?>">
                      </div>  
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td> {{ $data_row->year_from }} - {{ $data_row->year_to }}</td>
