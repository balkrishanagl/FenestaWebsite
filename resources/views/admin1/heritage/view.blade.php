           ...
           <input type="file" name="image_path" id="image_path" accept="image/jpeg,image/gif,image/x-png">
             ...
             <div class="form-group">
                ...
                <option value="{{ $key }}"   {{ $selected }}  >
                 ...
                 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Year from</label>
                  <div class="col-sm-10">
                    

                    <?php 
                    $year_from=date('Y');
                    if(isset($data_row->year_from) && $data_row->year_from){
                        $year_from=$data_row->year_from;
                    }                    
                    ?>

                  

                     <input type="number" min="1990" max="2099" step="1" value="{{ $year_from }}" / required="" id="year_from" name="year_from">
                </div>
                </div>


                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Year To</label>
                  <div class="col-sm-10">
                    

                    <?php 
                    $year_to=date('Y');
                    if(isset($data_row->year_to) && $data_row->year_to){
                        $year_to=$data_row->year_to;
                    }                    
                    ?>

                   
                     <input type="number" min="1990" max="2099" step="1" value="{{ $year_to }}" / required="" id="year_to" name="year_to">
                </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <textarea class="form-control summernote2" id="summernote" name="description">
