...
@section('title', 'Add Windows Product')
...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			@endif
			<div class="card-body">
				{{ Form::open(array('url' => 'admin/typesave','files' => true)) }}
				...
				<div class="form-group">
					...
					{{ Form::file('fullimage',array('class'=>'form-control')) }}                       <img src="#" style="display:none;" id="category-img-tag" width="200px" />

				</div>
                
				<div class="form-group">
					{{ Form::label('image', ' Icon*') }}
					{{ Form::file('image',array('class'=>'form-control')) }}                       <img src="#" style="display:none;" id="category-img-tag1" width="200px" />

				</div>
				<div class="form-group">
					{{ Form::label('hoverimage', 'Hover Icon*') }}
					{{ Form::file('hoverimage',array('class'=>'form-control')) }}                       <img src="#" style="display:none;" id="category-img-tag2" width="200px" />
