...
@section('title', 'Edit Window  Type')
...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			@endif
			<div class="card-body">
				{{ Form::model($banner, ['url'  => ['admin/Window/update', $banner->id], 'role'=> 'form','files'=>'true']) }}
    ...
    <br>
                    @if($banner->image)
                       <img src="{{asset("images/windowtype/$banner->image")}}" id="category-img-tag" width="150px" />
                    @else
    ...
    <br>
                    @if($banner->thumb_image)
                       <img src="{{asset("images/windowtype/$banner->thumb_image")}}" id="category-img-tag1" width="150px" />
                    @else
    ...
    <br>
                    @if($banner->featured_image)
                       <img src="{{asset("images/windowtype/$banner->featured_image")}}" id="category-img-tag2" width="150px" />
                    @else
               ...
               <div class="form-group">
                ...
                <div class="preview" >
                    @foreach(explode(',',$banner->multi_image) as $img)
                      <img src="{{asset("images/windowtype/$img")}}" width="100px">
                    @endforeach
                </div>
                @else
...
<br>
                    @if($banner->banner_image)
                       <img src="{{asset("images/windowtype/$banner->banner_image")}}" id="category-img-tag4" width="150px" />
                    @else
