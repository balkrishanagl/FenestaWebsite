...
@section('title', ' Great facade List')
...
<div class="col-md-4 text-right">
              <a class="btn btn-primary"  title="Add New" href="{{ URL::to('/') }}/admin/Greatfacade"><i class="fa fa-plus"></i> Add New</a>
...
<td><input type="checkbox" class="checkbox" data-emp-id="{{$testimonial->id}}" value="{{$testimonial->id}}"/></td>
				<td>{{$i}}</td>
				<td>{{$testimonial->title}}</td>
				<td><img height="50px" width="50px" src={!!asset("images/greatfacade/$testimonial->reference_image")!!}></td><td>{{$testimonial->status}}</td>
				<td><a title="Edit" href="{{URL('admin/editGreatfacade',['id' => $testimonial->id])}}"><i class="fas fa-edit"></i></a> <a href="javascript:void(0)" title="Delete" data-id = "{{$testimonial->id}}" class="delete"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
			<?php $i++; ?>
			@endforeach
		</tbody>
