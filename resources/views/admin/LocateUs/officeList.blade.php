...
<div class="col-md-4 text-right">
    <a class="btn btn-primary" title="Add New" href="{{URL('admin/addOffice')}}"><i class="fa fa-plus"></i> Add New</a> 
...
<div class="card-body table-responsive p-0"><input type="hidden" class="tb" value="offices">
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		...
		<tbody>
			...
			<tr><td><input type="checkbox" class="checkbox" data-emp-id="{{$office->id}}" value="{{$office->id}}"/></td>
				<td>{{$i}}</td>
				...
				<td>{{$office->city}}</td>
				<td>{{$office->status}}</td>
				<td><a title="Edit" href="{{URL('admin/editOffice',['id' =>$office->id])}}"><i class="fas fa-edit"></i></a> <a title="Delete" href="javascript:void(0)" data-id = "{{$office->id}}" class="delete"><i class="fas fa-trash-alt"></i></a> </td>
