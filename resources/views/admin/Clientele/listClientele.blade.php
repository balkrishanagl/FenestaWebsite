...
<div class="col-md-4 text-right">
              <a class="btn btn-primary" title="Add New" href="{{ URL::to('/') }}/admin/Clientele"><i class="fa fa-plus"></i> Add New</a>
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		...
		<tbody>
			...
			<tr><td><input type="checkbox" class="checkbox" data-emp-id="{{$galleryData->id}}" value="{{$galleryData->id}}"/></td>
				...
				<td><img width="150px" src={!!asset("images/gallery_images/$galleryData->image")!!}></td>
                 <td>{{ $galleryData->status }}</td>
				<td><a title="Edit" href="{{URL('admin/editClientele',['id' => $galleryData->id])}}"><i class="fas fa-edit"></i></a> <a href="#" data-id = "{{$galleryData->id}}" title="Delete" class="delete"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
			<?php $i++; ?>
			@endforeach
		</tbody>
