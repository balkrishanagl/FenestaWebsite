...
{{--
 <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <h3> Blog Categories(<?php echo $data_rows->total();?> Records)</h3>
                </div>
                  <div class="col-md-4 text-right">
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		<thead>
            ...
            <td><span class="label label-<?php echo ($data_row->status=='1')?'success':'danger';?>">
                   {{-- Config::get('constants.CONS_STATUS_ARRAY')[$data_row->status] ---}}
                {{$data_row->status}}</span></td>
                 ...
                 {{--  <td>{{ $data_row->updated_at->format('F j, Y') }}</td> --}}
                  ...
                  <a href="<?php echo Request::url();?>?delete=<?php echo $data_row->id;?>" title="Delete " class="delete " onclick="return confirm('Are you sure you want to delete {{$data_row->title}}?');"><i class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
               @endforeach
