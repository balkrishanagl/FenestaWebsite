        ...
        <tbody> @php $er=1;
            ...
            <td><span class="label label-<?php echo ($data_row->status=='1')?'success':'danger';?>">
                 ...
                 {{--  <td>{{ $data_row->posted_date }}</td> --}}
                  ...
                  <a title="Delete " href="<?php echo Request::url();?>?delete=<?php echo $data_row->id;?>" onclick="return confirm('Are you sure you want to delete {{$data_row->name}}?');" class="delete"><i class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
               @endforeach
