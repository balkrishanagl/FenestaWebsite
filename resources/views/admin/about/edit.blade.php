...
<div class="row">
	<div class="col-12">
		<div class="card">
			...
			@endif
			<div class="card-body">
				{{ Form::model($news, ['url'  => ['admin/updateAbout', $news->id], 'role'=> 'form','files'=>'true']) }}
			...
			<div class="form-group">
                ...
                <br>
                    @if($news->image)
                       <img src="{{asset("images/about/$news->image")}}" id="category-img-tag" width="150px" />
                    @else
