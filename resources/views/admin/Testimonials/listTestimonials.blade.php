...
<div class="col-md-4 text-right">
              <a class="btn btn-primary"  title="Add New" href="{{ URL::to('/') }}/admin/Testimonials"><i class="fa fa-plus"></i> Add New</a>
	...
	<table class="data-table table table-head-fixed text-nowrap table-bordered" id="user_table">
		...
		<tbody>
			...
			<tr>
              ...
              <td>{{$category[$testimonial->category]}}</td>
                <td>{{$testimonial->status}}</td>
				<td><a title="Edit" href="{{URL('admin/editTestimonial',['id' => $testimonial->id])}}"><i class="fas fa-edit"></i></a> <a href="javascript:void(0)" title="Delete" data-id = "{{$testimonial->id}}" class="delete"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
			<?php $i++; ?>
			@endforeach
		</tbody>
