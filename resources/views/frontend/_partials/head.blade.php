<head>
    ...
    @if(!empty($pageData[0]->meta_title))
      <title>{{ $pageData[0]->meta_title }}</title>
    @else
      <title>Fenesta</title>
    @endif
      <meta charset="utf-8">
        @if(!empty($pageData[0]->meta_description))
         <meta name="description" content="{{ $pageData[0]->meta_description }}">
        @else
        <meta name="description" content="">
        @endif
      
        @if(!empty($pageData[0]->meta_keyword))
         <meta name="keywords" content="{{ $pageData[0]->meta_keyword }}" />
        @else
        <meta name="keywords" content="" />
        @endif
      
        @if(!empty($pageData[0]->og_title))
         <meta property="og:title" content="{{ $pageData[0]->og_title }}" />
        @else
        <meta property="og:title" content="" />
        @endif
      
        @if(!empty($pageData[0]->og_desc))
         <meta property="og:description" 
          content="{{ $pageData[0]->og_desc }}" />
        @else
        <meta property="og:description" 
          content="" />
        @endif
        @if(!empty($pageData[0]->og_image))
         <meta property="og:image" 
          content="{{ asset('images').'/'.$pageData[0]->og_image }}" />
        @else
        <meta property="og:image" 
          content="" />
        @endif
