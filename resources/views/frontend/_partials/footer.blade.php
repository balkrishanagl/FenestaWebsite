            ...
            <div class="footer-menu-box">
              ...
              <ul>
                ...
                <li><a href="{{ URL('/showcase/gallery') }}">Showcase</a></li>
                 {{--   <li><a href="{{ url('/windows-doors/handles') }}">Windows & doors Handles</a></li>  --}}
              </ul>
            </div>
            <div class="footer-menu-box">
...
{{--
  <div class="modal fade welcome-popup1" id="welcome-popup1">    
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">      
        <!-- Modal Header -->
        <button type="button" class="close" data-dismiss="modal"><img src="{{ asset('images/site_images/images/close-pop.png')}}"></button> 
        ...
        <div class="modal-body">          
          <div class="content">
            <div class="top-content">
              <img src="{{ asset('images/site_images/images/mesh/welcome-banner1.jpg')}}">
...
function get_enter_web_traffic(){
    var data = { "_token": "{{ csrf_token() }}",'action' : 'enter'}; 
    $.post('{{url("ajax_user_count")}}',data,function(response){
...
@if(date('H:i:s') >= '10:00:00' and '18:00:00' >= date('H:i:s')  )
