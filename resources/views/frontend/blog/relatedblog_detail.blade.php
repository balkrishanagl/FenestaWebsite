            ...
            <div class="left-col">              
              ...
              <div class="pagination">
                ...
                <?php if(App\Models\BlogPageModel::getPostPrv($post_data->id)!=''){?>
                    ...
                    <a href="{{App\Models\BlogPageModel::getPostUrl(App\Models\BlogPageModel::getPostPrv($post_data->id)->slug)}}" class="white-btn prev"> Prev
                    </a>
                
                <?php } ?>
                 
                <?php if(App\Models\BlogPageModel::getPostNaxt($post_data->id)!=''){?>
                    <a href="{{App\Models\BlogPageModel::getPostUrl(App\Models\BlogPageModel::getPostNaxt($post_data->id)->slug)}}" class="white-btn next">Next
                    </a>
                  <?php } ?>
                ...
                <div class="social-link">
                  ...
                  <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{App\Models\BlogPageModel::getPostUrl($post_data->slug)}}"><img src="{{ asset('images/site_images/fb.png') }}"></a>
                  <a target="_blank" href="https://twitter.com/intent/tweet?text={{ $post_data->page_title }}&amp;url={{App\Models\BlogPageModel::getPostUrl($post_data->slug)}}"><img src="{{ asset('images/site_images/tweet.png') }}"></a>
                  <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{App\Models\BlogPageModel::getPostUrl($post_data->slug)}}&amp;title={{ $post_data->page_title }}"><img src="{{ asset('images/site_images/linked.png') }}" ></a>
                 {{--  <a href="javascript:;"><img src="{{ asset('images/site_images/yt.png') }}"></a> --}}
                  <a href="https://www.instagram.com/?url={{App\Models\BlogPageModel::getPostUrl($post_data->slug)}}" target="_blank"><img src="{{ asset('images/site_images/insta-icon.png') }}"></a>
                </div>
              </div>
