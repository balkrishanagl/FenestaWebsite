      ...
      <div class="locate-tab-sec">
        <div class="container-fluid">
          <ul class="locate-link">
            <li><a href="#signature-studio" class="active">Signature Studio</a></li>
            <li><a href="#partner-showroom" >Partner Showroom</a></li>            
            <li><a href="#fenesta-offices">Fenesta Offices</a></li>          
          </ul>
        </div>
        <div class="locate-tab-list">
          <div class="container-fluid">
            <div class="locate-tab-box" id="signature-studio" style="display: block;">
...
<!--                    <option>Select Country</option>-->
                  ...
                  <select class="select" name="fstate" id="fstate">
                    <option value="">Select State</option>
                      ...
                      @foreach($stateshowrooms as $sts)
                       <option value="{{$sts->state}}">{{$sts->state}}</option>
                      @endforeach
                  </select>
                </div>
                <div class="form-group">
                  <select class="select"  name="fcity" id="fcity">
                   ...
                   {{--   @foreach($cityshowrooms as $sts)
                       <option value="{{$sts->city}}">{{$sts->city}}</option>
                      @endforeach --}}
                  </select>
                </div>
                <div class="form-group">
                  <select class="select" id="fblock">
                    ...
                    {{--  @foreach($blockshowrooms as $sts)
                       <option value="{{$sts->locality}}">{{$sts->locality}}</option>
                      @endforeach --}}
                  </select>
                </div>                
              </div>
              <div class="inner-box">
                <div class="left">
					...
					<div class="address-list-slider owl-carousel">
                        ...
                        @php 
                        $mapdata[]=array(0=>$sroom->city,$sroom->lat,$sroom->long,"$sroom->address,$sroom->city,$sroom->state","Signature Studio");
                        @endphp
						<div class="lu_item">
							<div class="head">
                ...
                <div class="right video-sliderss">
                  <div class=" video-slider owl-carousel">
                      ...
                      @if($sroom->video_url)
                   <div class="item">
                      <iframe width="560" height="315" src="{{$sroom->video_url}}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                      @endif
                    @endforeach
                  </div>
            ...
            <div class="locate-tab-box" id="partner-showroom">
...
<!--                    <option>Select Country</option>-->
              ...
              <div class="inner-box">
                <div class="left">
                  <div class="address-list-slider owl-carousel">
                       ...
                       @php 
                        $mapdata[]=array(0=>$sroom->city,$sroom->lat,$sroom->long,"$sroom->address,$sroom->city,$sroom->state","Partner Showroom");
                        @endphp
						<div class="lu_item">
							<div class="head">
								<h4><img src="{{ asset('images/site_images/images/right-arrow.png')}}" alt="">{{$sroom->city}}</h4>
            ...
            <div class="locate-tab-box" id="fenesta-offices">
                ...
                <div class="form-group">
                  <select class="select" id="ooblock">
                    ...
                    {{--  @foreach($blockoshowrooms as $sts)
                       <option value="{{$sts->type}}">{{$type_officce[$sts->type]}}</option>
                      @endforeach --}}
                  </select>
                </div>                
              </div>
              <div class="inner-box">
                <div class="left">
                  <div class="address-list-slider owl-carousel">
                      ...
                      @php 
                        $mapdata[]=array(0=>$sroom->city,$sroom->lat,$sroom->long,"$sroom->address,$sroom->city,$sroom->state","Fenesta Offices");
                        @endphp
						<div class="lu_item">
							<div class="head">
								<h4><img src="{{ asset('images/site_images/images/right-arrow.png')}}" alt="">{{$sroom->city}}</h4>
